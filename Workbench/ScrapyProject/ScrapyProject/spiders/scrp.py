...
import sys
sys.path.append('C:/Users/SimónContreras/Desktop/E3/E4/Workbench/TextClassifier')
...
class QuotesSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for item in Lista_completa:
            if leer == 1:
                if item in Imagenes:
                    ...
                    Lista_imagenes_final.append([link,"imagen",k,titulo,url,100,100])
                    k = k + 1
                elif item in Videos:
        ...
        for info in Lista_informaciones_final:
            classified = classify('C:/Users/SimónContreras/Desktop/E3/E4/Workbench/TextClassifier/classifier_bayes.pickle', info[0])
        ...
        yield scrapy.Request('http://blogthinkbig.com/experimentos-magnetismo/', callback=self.parse)
